...
StrategyConfig fields:
  coin_source.source_type: "static"(fixed coin list) | "ai500"(AI top500 ranking) | "oi_top"(OI increasing, suited for long) | "oi_low"(OI decreasing, suited for short) | "hunter"(Hunter v6) | "hunter_sniff"(institutional ambush filter) | "hunter_v7"(multi-setup Alpha Signal Router) | "mixed"
