        ...
        <div className="w-full max-w-[1120px]">
          <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div
                  className={`font-semibold uppercase text-primary/80 ${
                    isZh
                      ...
                      <div className="flex items-stretch gap-3">
                        ...
                        <div className="flex shrink-0 flex-col justify-end">
                          <Button
                            ...
                            className="inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-primary/20 bg-primary/10 text-primary transition hover:bg-primary/15"
