...
export const translations = {
  en: {
    ...
    strategyStudio: {
      ...
      promptCompactModeDesc:
        'Controls how candidate market data is rendered for the LLM.',
      promptCompactHunterV7: 'Hunter v7 only',
      promptCompactCurrentSource: 'Current source only ({source})',
  ...
  zh: {
    ...
    strategyStudio: {
      ...
      promptCompactCurrentSource: '仅当前数据源（{source}）',
  ...
  id: {
    ...
    strategyStudio: {
      ...
      promptCompactModeDesc:
        'Mengontrol cara data pasar kandidat dikirim ke LLM.',
      promptCompactHunterV7: 'Hunter v7 saja',
      promptCompactCurrentSource: 'Hanya sumber saat ini ({source})',
