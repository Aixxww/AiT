...
export const translations = {
  en: {
    ...
    apiConnectionTimeout: 'SnapshotStore is still warming up or returned empty data',
    ...
    orConfigureCorrectApiUrl: 'Or wait for SnapshotStore warm-up and verify Binance connectivity',
  ...
  zh: {
    ...
    orConfigureCorrectApiUrl: '或者等待 SnapshotStore 预热并检查 Binance 连通性',
  ...
  id: {
    ...
    ai500Description: 'Kandidat AI500 berasal dari Binance Futures SnapshotStore lokal; endpoint API sumber data tambahan tidak diperlukan',
    oiTopDescription: 'Peringkat open interest berasal dari Binance Futures SnapshotStore lokal',
    information: 'Informasi',
    signalSourceInfo1: '• Sumber sinyal membaca SnapshotStore backend, bukan URL eksternal per pengguna',
    signalSourceInfo2: '• Saat membuat trader, Anda dapat memilih apakah akan menggunakan sumber sinyal ini',
    signalSourceInfo3: '• Data Binance Futures diambil sekali oleh backend dan digunakan ulang oleh strategi',
    ...
    heroTitle1: 'Read the Market.',
    heroTitle2: 'Write the Trade.',
    heroDescription: 'AiT adalah standar masa depan untuk trading AI — OS trading agensi yang terbuka dan didorong komunitas. Mendukung Binance, Aster DEX dan bursa lainnya, self-hosted, kompetisi multi-agen, biarkan AI secara otomatis membuat keputusan, mengeksekusi dan mengoptimalkan trading untuk Anda.',
    poweredBy: 'Didukung oleh Aster DEX dan Binance.',
    readyToDefine: 'Siap mendefinisikan masa depan trading AI?',
    startWithCrypto: 'Dimulai dari pasar kripto, berkembang ke TradFi. AiT adalah infrastruktur AgentFi.',
    ...
    riskWarningText: 'Branch dev tidak stabil, jangan gunakan dana yang tidak sanggup Anda rugi. AiT non-custodial, tanpa strategi resmi. Trading memiliki risiko, investasi dengan hati-hati.',
    ...
    ai500ApiNotConfigured: 'Pool snapshot lokal AI500 belum memiliki kandidat (periksa warm-up SnapshotStore dan koneksi Binance)',
    apiConnectionTimeout: 'SnapshotStore masih warm-up atau mengembalikan data kosong',
    noCustomCoinsAndApiFailed: 'Tidak ada koin kustom dan pool kandidat snapshot lokal kosong',
    solutions: 'Solusi:',
    setCustomCoinsInConfig: 'Atur daftar koin kustom di konfigurasi trader',
    orConfigureCorrectApiUrl: 'Atau tunggu warm-up SnapshotStore dan periksa koneksi Binance',
    orDisableAI500Options: 'Atau nonaktifkan "AI500 Local Snapshot Pool" dan "OI Top"',
    signalSourceNotConfigured: 'Pool Kandidat Snapshot Kosong',
    signalSourceWarningMessage: 'Trader mengaktifkan "AI500 Local Snapshot Pool" atau "OI Top", tetapi SnapshotStore belum menghasilkan kandidat. Jumlah kandidat dapat tetap 0 sampai snapshot lokal selesai warm-up.',
    ...
    faqIsProfitableAnswer: 'Trading AI bersifat eksperimental dan TIDAK dijamin menguntungkan. Futures kripto sangat volatil dan berisiko. AiT dirancang untuk tujuan edukasi dan riset. Kami sangat menyarankan: mulai dengan jumlah kecil (10-50 USDT), jangan investasi melebihi yang sanggup Anda rugi, uji sebelum trading nyata.',
    ...
    faqSupportedAIModelsAnswer: 'AiT mendukung 7+ model AI: DeepSeek (direkomendasikan untuk biaya/performa), Qwen, OpenAI (GPT), Claude, Gemini, Grok, dan Kimi. Anda juga dapat menggunakan endpoint API yang kompatibel dengan OpenAI.',
    ...
    faqHyperliquidSetupAnswer: 'Hyperliquid adalah bursa terdesentralisasi. Langkah: 1) Kunjungi app.hyperliquid.xyz; 2) Hubungkan wallet; 3) Buat API wallet; 4) Salin alamat dan private key; 5) Tambahkan di AiT. Tanpa KYC.',
    ...
    faqMultipleTradersAnswer: 'Ya! AiT mendukung 20+ trader bersamaan. Gunakan untuk A/B test strategi, bandingkan model AI, atau diversifikasi lintas bursa.',
    ...
    faqPortInUseAnswer: 'Periksa proses yang menggunakan port. Ubah port di .env: AiT_BACKEND_PORT=8081, AiT_FRONTEND_PORT=3001.',
    ...
    faqBinancePositionModeAnswer: 'Anda dalam mode One-way tetapi AiT memerlukan Hedge Mode. Tutup semua posisi, beralih ke Hedge Mode, restart trader.',
    ...
    faqEncryptionDetailsAnswer: 'AiT menggunakan: 1) AES-256-GCM untuk penyimpanan database; 2) RSA-2048 untuk enkripsi transport opsional; 3) JWT untuk token autentikasi.',
    ...
    faqCanAiTStealFundsAnswer: 'AiT open-source (lisensi AGPL-3.0) - Anda bisa audit semua kode. API key disimpan lokal di mesin ANDA, tidak pernah dikirim ke server eksternal.',
    ...
    faqCustomAIAPIAnswer: 'Ya! AiT mendukung API yang kompatibel dengan OpenAI. Masukkan URL endpoint, API key, dan nama model.',
    faqAIHallucinations: 'Bagaimana dengan halusinasi AI?',
    faqAIHallucinationsAnswer: 'AiT memitigasi dengan: prompt terstruktur, format output JSON, dan validasi order sebelum eksekusi. Namun trading AI tetap eksperimental.',
    ...
    environmentCheck: {
      ...
      unsupportedDesc: 'Buka AiT melalui HTTPS (atau http://localhost saat pengembangan).',
