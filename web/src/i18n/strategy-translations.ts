...
export const coinSource = {
  ...
  binanceNote: { zh: '数据来自 Binance API（通过本地策略引擎）', en: 'Data via Binance API (local strategy engine)', es: 'Datos desde Binance API (motor local)' },
...
export const indicator = {
  ...
  binanceTitle: { zh: 'Binance 数据源', en: 'Binance Data Provider', es: 'Proveedor Binance' },
  binanceDesc: { zh: 'Binance 合约实时数据驱动 AI 量化', en: 'Binance Futures real-time data powering AI quant', es: 'Datos de Binance Futures impulsando IA quant' },
  binanceFeatures: { zh: 'AI500 · OI排行 · 资金流向 · 涨跌榜', en: 'AI500 · OI Ranking · Fund Flow · Price Ranking', es: 'AI500 · OI · NetFlow · Ranking' },
  ...
  binanceDataSources: { zh: 'Binance 数据源', en: 'Binance Data Sources', es: 'Fuentes Binance' },
  configureApiKey: { zh: '请配置 API Key 以启用数据源', en: 'Please configure API Key to enable data sources', es: 'Configure API Key para habilitar fuentes de datos' },
};
