// AiT i18n Consolidation - Translation Keys
...
export const coinSource = {
  ...
  ai500: { zh: 'AI500 本地快照池', en: 'AI500 Local Snapshot Pool', es: 'Pool Snapshot Local AI500' },
  ...
  useAI500: { zh: '启用 AI500 本地快照池', en: 'Enable AI500 Local Snapshot Pool', es: 'Habilitar Pool Snapshot AI500' },
  ...
  binanceNote: { zh: '数据来自 Binance Futures SnapshotStore（本地快照引擎）', en: 'Data from Binance Futures SnapshotStore (local snapshot engine)', es: 'Datos desde Binance Futures SnapshotStore (motor local)' },
  ai500Desc: { zh: '使用本地快照引擎评分后的 AI500 热门币池', en: 'Use AI500 candidates scored from the local snapshot engine', es: 'Candidatos AI500 desde snapshot local' },
  ...
  square_heat: { zh: '广场热度', en: 'Square Heat', es: 'Cuadrado Calor' },
  square_heatDesc: { zh: '币安广场社交热度 + 合约信号评分', en: 'Binance Square social heat + on-chain signals', es: 'Binance Square social + señales en cadena' },
  hunter: { zh: '猎手选币', en: 'Hunter', es: 'Cazador' },
  hunterDesc: { zh: '智能猎手筛选，寻找即将爆发的币种', en: 'Smart hunter scoring, find coins about to break out', es: 'Filtro inteligente, buscar monedas a punto de explotar' },
  hunter_sniff: { zh: '庄家嗅探', en: 'Hunter Sniff', es: 'Cazador Olfateo' },
  hunter_sniffDesc: { zh: '庄家嗅探 - 3条件共振', en: 'Institutional ambush detector', es: 'Detector de emboscada institucional' },
  hunter_v7: { zh: '猎手 v7', en: 'Hunter v7', es: 'Cazador v7' },
  hunter_v7Desc: { zh: 'v7 信号路由，多市场结构候选池', en: 'v7 signal router across market-structure setups', es: 'Router de señales v7 con estructuras de mercado' },
  indicator_hub: { zh: '多因子引擎', en: 'Indicator Hub', es: 'Indicador Hub' },
  indicator_hubDesc: { zh: '技术+量化+社交多因子评分系统', en: 'Tech+Quant+Social multi-factor scoring engine', es: 'Motor multifactor Tech+Quant+Social' },
  useHunter: { zh: '启用猎手选币', en: 'Enable Hunter', es: 'Habilitar Cazador' },
  hunterLimit: { zh: '数量上限', en: 'Limit', es: 'Límite' },
  hunterDirection: { zh: '信号方向', en: 'Signal Direction', es: 'Dirección de Señal' },
  hunterDirectionLong: { zh: '做多', en: 'LONG', es: 'LARGO' },
...
export const indicator = {
  ...
  binanceTitle: { zh: 'Binance Futures SnapshotStore', en: 'Binance Futures SnapshotStore', es: 'Binance Futures SnapshotStore' },
  binanceDesc: { zh: '本地快照层驱动 AI 量化', en: 'Local snapshot layer powering AI quant', es: 'Snapshot local para IA quant' },
  binanceFeatures: { zh: 'AI500 · OI排行 · 资金流向 · 涨跌榜 · 200根K线', en: 'AI500 · OI Ranking · Fund Flow · Price Ranking · 200 klines', es: 'AI500 · OI · NetFlow · Ranking · 200 velas' },
  viewApiDocs: { zh: 'API 文档', en: 'API Docs', es: 'Docs API' },
  apiKey: { zh: 'API Key', en: 'API Key', es: 'API Key' },
  apiKeyPlaceholder: { zh: '输入 API Key', en: 'Enter API Key', es: 'Ingresar API Key' },
  ...
  snapshotReady: { zh: '本地快照已启用', en: 'Local Snapshot Enabled', es: 'Snapshot Local Activo' },
  snapshotStoreDesc: { zh: '无需额外数据源 API Key。数据由后端统一 SnapshotStore 从 Binance Futures 拉取并缓存，策略只读取本地热快照。', en: 'No extra data-source API key is required. The backend SnapshotStore fetches and caches Binance Futures data, and strategies read the local hot snapshot.', es: 'No requiere API Key adicional para datos. SnapshotStore obtiene Binance Futures y las estrategias leen snapshot local.' },
  binanceDataSources: { zh: 'SnapshotStore 数据模块', en: 'SnapshotStore Data Modules', es: 'Módulos SnapshotStore' },
  configureApiKey: { zh: '本地 SnapshotStore 无需 API Key', en: 'Local SnapshotStore does not require an API key', es: 'SnapshotStore local no requiere API Key' },
};
