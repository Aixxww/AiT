...
export const coinSource = {
  ...
  nofxosNote: { zh: '数据来自 Binance API（通过本地策略引擎）', en: 'Data via Binance API (local strategy engine)', es: 'Datos desde Binance API (motor local)' },
...
export const indicator = {
  ...
  nofxosTitle: { zh: 'Binance 数据源', en: 'Binance Data Provider', es: 'Proveedor Binance' },
  nofxosDesc: { zh: 'Binance 合约实时数据驱动 AI 量化', en: 'Binance Futures real-time data powering AI quant', es: 'Datos de Binance Futures impulsando IA quant' },
  ...
  nofxosDataSources: { zh: 'Binance 数据源', en: 'Binance Data Sources', es: 'Fuentes Binance' },
