  ...
  return (
    <div className="binance-card p-4">
      ...
      <div className="space-y-2 max-h-[300px] overflow-y-auto">
        {runs.length === 0 ? (
          <div className="py-8 text-center text-sm" style={{ color: 'var(--color-muted-fg)' }}>
          ...
          runs.map((run) => (
            <button
              ...
              style={{
                background: run.run_id === selectedRunId ? 'color-mix(in srgb, var(--color-primary) 10%, transparent)' : 'var(--color-panel)',
              ...
              <div className="flex items-center justify-between mt-1">
                ...
                >
                  <Eye
                    className="w-3 h-3"
                    style={{
                      color: compareRunIds.includes(run.run_id) ? 'var(--color-primary)' : 'var(--color-muted-fg)',
                    }}
                  />
                </button>
              </div>
