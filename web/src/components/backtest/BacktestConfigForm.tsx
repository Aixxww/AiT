...
import { ChevronRight, ChevronLeft, RefreshCw, Zap } from 'lucide-react'
    ...
    switch (st) {
      ...
      case 'mixed': {
        ...
        if (cs.static_coins?.length)
          parts.push(`Static(${cs.static_coins.length})`)
    ...
    <div className="binance-card p-5">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="ml-2 text-xs text-muted-foreground">
          {wizardStep === 1
            ? globalT('backtestConfigForm.selectModel', lang)
            : wizardStep === 2
              ? globalT('backtestConfigForm.configure', lang)
          ...
          {wizardStep === 1 && (
            ...
            >
              ...
              <div>
                ...
                >
                  <option value="">
                    {globalT('backtestConfigForm.noSavedStrategy', lang)}
                  </option>
                  {strategies?.map((s) => (
                ...
                <div className="relative">
                  <textarea
                    ...
                    placeholder={
                      strategyHasDynamicCoins
                        ? globalT(
                            'backtestConfigForm.leavEmptyForStrategy',
                            lang
                          )
                        : ''
                    }
                    ...
                    return (
                      <Button
                        ...
                        onClick={() => {
                          ...
                          if (updated.length > 0)
                            onFormChange('timeframes', updated)
                        }}
                        className="px-2 py-1 rounded text-xs transition-all"
                        style={{
                          background: isSelected
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onFormChange('balance', Number(e.target.value))
                    }
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onFormChange('btcEthLeverage', Number(e.target.value))
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onFormChange('altcoinLeverage', Number(e.target.value))
                    }
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                <div>
                  ...
                  <input
                    ...
                    value={formState.fee}
                    onChange={(e) =>
                      onFormChange('fee', Number(e.target.value))
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onFormChange('slippage', Number(e.target.value))
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onFormChange('cadence', Number(e.target.value))
                    }
                  />
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      onFormChange('replayOnly', e.target.checked)
                    }
                    className="accent-[var(--color-primary)]"
                  />
