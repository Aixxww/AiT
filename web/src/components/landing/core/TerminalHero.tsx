        ...
        <section className="relative w-full min-h-screen bg-ait-bg text-ait-text overflow-hidden flex flex-col pt-20">
            ...
            <div className="absolute bottom-0 w-full bg-black/80 border-t border-zinc-800/50 backdrop-blur-md z-30 overflow-hidden py-2 flex items-center">
                <div className="flex animate-marquee whitespace-nowrap gap-12 text-xs font-mono text-zinc-500 px-4">
                    ...
                    <span className="flex items-center gap-2"><CircuitBoard className="w-3 h-3 text-ait-accent" /> AI MODEL: Claude Opus 4.6</span>
...
function CommunityStats() {
    const { stars, forks, contributors, isLoading, error } = useGitHubStats("Aixxww", "AiT")
