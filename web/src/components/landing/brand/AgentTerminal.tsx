        ...
        <div className="p-4 border-b border-border/40">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-muted-foreground text-[10px] font-mono">
              Spread: <span className="text-primary">0.02%</span>
            </span>
          </div>
        ...
        <div className="p-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between py-2 px-2 rounded-lg bg-surface/50 hover:bg-surface-alt transition-colors"
              >
