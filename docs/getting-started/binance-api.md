...
This guide explains how to create and configure Binance API keys for use with AiT.
...
6. Name your API key (e.g., "AiT Trading")
...
Add your API credentials through the AiT web interface:

1. Open AiT dashboard (http://localhost:3000)
