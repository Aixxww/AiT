...
func TestFinalizeV7SignalAnnotatesFlowConfirmedBreakoutTriggerNear(t *testing.T) {
	sig := &V7SignalOutput{
		...
		LiquidityScore: 85,
		EntryMode:      V7EntryBreakout,
		ReasonCodes:    []string{"approaching_breakout", "taker_aggressive_buy", "clear_air_above"},
...
func TestFinalizeV7SignalPromotesConfirmedBreakoutToOpenNow(t *testing.T) {
	sig := &V7SignalOutput{
		...
		LiquidityScore: 85,
		EntryMode:      V7EntryBreakout,
		ReasonCodes:    []string{"breakout_attempt", "taker_aggressive_buy", "clear_air_above"},
...
func TestFinalizeV7SignalBlocksLeaderMomentumUpperZoneChase(t *testing.T) {
	sig := &V7SignalOutput{
		...
		ReasonCodes:      []string{"strong_24h_momentum", "solid_4h_momentum", "accelerating_1h", "oi_healthy_growth", "taker_strong_buy", "no_pullback_still_running"},
