...
var hunterV7TagCatalog = map[string]HunterV7TagDefinition{
	...
	"taker_buy_borderline":                     tagDef("taker_buy_borderline", "risk_tag", "flow", "bullish", V7TagActionReduceOrWait, "Taker buy ratio sits within sampling noise of the flow cutoff; opening is allowed with reduced size, not full conviction."),
