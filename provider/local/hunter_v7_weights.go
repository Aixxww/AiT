...
var regimeWeightMatrix = map[regimeWeightKey]float64{
	...
	// relative_weakness_short hunts the weakest names in any non-crashing
	// tape; in panic regimes the panic/breakdown modules own the short side.
	{V7RegimeTrendUp, V7SetupRelativeWeaknessShort}:   0.9,
	{V7RegimeTrendDown, V7SetupRelativeWeaknessShort}: 1.2,
	{V7RegimeRange, V7SetupRelativeWeaknessShort}:     1.0,
	{V7RegimeRotation, V7SetupRelativeWeaknessShort}:  1.1,
	{V7RegimePanicDump, V7SetupRelativeWeaknessShort}: 0.5,
	{V7RegimeManiaPump, V7SetupRelativeWeaknessShort}: 0.6,
