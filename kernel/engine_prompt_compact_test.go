...
func hunterV7ShortSideTierCases() []v7TierCase {
	return []v7TierCase{
		...
		{
			name: "TestClassifyHunterV7CandidateTierBlocksRangeExpansionLongNegativeOIHighZone",
			coin: v7Candidate("range_expansion_event",
				withSymbol("SATSUSDT"),
				withQuality("ready"),
				withScores(86.3, 93.6, 87, 0, 90),
				withRiskLevel("LOW"),
				withReasons("range_expansion_event", "amplitude_24h_event", "moderate_range_expansion_event", "event_continuation_long", "volume_burst_5m", "flow_taker_buy_aligned", "range_expansion_retest", "retest_confirmed", "entry_open_now"),
				withRiskTags("execution_stop_tightened"),
				withConfirms("15m_close_above_vwap_or_ema20_or_entry_zone_upper", "taker_buy_15m_gt_0_52", "no_new_low_after_reclaim"),
				withZone(0.000011312187535522572, 0.00001150958848495821),
				withInvalidation(0.0000112112),
				withTargets(local.V7Target{Price: 0.000011967595889906069}, local.V7Target{Price: 0.000012236464105450325}),
				withPriceCtx(&local.V7PriceContext{Last: 0.00001144, Change1h: 3.44, Change4h: 4.19, Change24h: 3.78, VWAP15m: 0.000011381776020480782}),
				withDerivatives(-5.86, 8.31, 0.5628),
				withReadiness(&local.V7ExecutionReadiness{
					Tier:         local.V7ReadinessExecutable,
					Reason:       "readiness_ready",
					ReadyScore:   86.0,
			...
			wantTier:   "WATCH",
			wantReason: "range_expansion_long_negative_oi_high_zone_wait",
		},
		{
