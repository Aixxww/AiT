...
func (c *StrategyConfig) ClampLimits() {
	...
	// Clamp Square Heat limit
	if c.CoinSource.SquareHeatLimit <= 0 || c.CoinSource.SquareHeatLimit > MaxCandidateCoins {
...
type CoinSourceConfig struct {
	...
	// whether to use Binance Square social heat as a coin source
	UseSquareHeat bool `json:"use_square_heat"`
	// Binance Square heat limit per selection
	SquareHeatLimit int `json:"square_heat_limit,omitempty"`
	// Binance Square monitor base URL (default "http://localhost:8000")
